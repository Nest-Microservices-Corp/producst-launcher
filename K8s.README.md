...
# Crear service
```
kubectl create service clusterip <nombre> --tcp=<8888> --dry-run=client -o yaml | Out-file ./service.yml -Encoding UTF8 
**kubectl create service nodeport <nombre> --tcp=<3000> --dry-run=client -o yaml | Out-file ./service.yml -Encoding UTF8 **
```
